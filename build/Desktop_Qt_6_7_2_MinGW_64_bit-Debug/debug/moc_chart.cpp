...
struct qt_meta_stringdata_CLASSChartENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSChartENDCLASS = QtMocHelpers::stringData(
    "Chart"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChartENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Chart::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSChartENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSChartENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChartENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Chart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSChartENDCLASS.stringdata0))
